public class FindLongestPalindromeInWord {


    public static void main(String[] args) {
        FindLongestPalindromeInWord findLongestPalindromeInWord = new FindLongestPalindromeInWord();
    String word = "hello";

        System.out.println(findLongestPalindromeInWord.findLongestPalindrome(word));
